...
## Data description
The project will be based on a clinical trials dataset related to temperature, pressure and respiration related parameters, which can be accessed from the provided database. The dataset contains 85000 rows and 35 columns of data. The project will focus on two essential columns of the dataset:
- Title 
- Abstract
